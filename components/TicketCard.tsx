    ...
    <div className="relative w-full max-w-[400px] mx-auto overflow-hidden rounded-[3rem] shadow-2xl bg-white text-assirou-navy border border-slate-100">
      ...
      <div className="bg-assirou-navy text-white p-10 relative">
        ...
        <div className="relative z-10">
          ...
          <h2 className="text-[15px] font-black leading-tight uppercase border-l-4 border-assirou-gold pl-4">
      ...
      <div className="p-10 bg-slate-50">
        <div className="mb-8">
          <p className="text-[9px] text-slate-400 uppercase font-black mb-1">Détenteur du Pass</p>
          <h3 className="text-2xl font-black text-assirou-navy truncate">{participant.nom_complet}</h3>
        ...
        <div className="grid grid-cols-2 gap-6 mb-10 border-y border-slate-200 py-6">
          <div>
            <p className="text-[8px] text-slate-400 uppercase font-black mb-1">Date & Heure</p>
            <p className="text-[11px] font-black text-assirou-navy">05 Mars 2026</p>
            <p className="text-[10px] font-bold text-assirou-gold">10h00 - 16h00</p>
          </div>
          <div>
            <p className="text-[8px] text-slate-400 uppercase font-black mb-1">Lieu</p>
            <p className="text-[10px] font-black text-assirou-navy leading-tight">CSC Thiaroye<br/>sur Mer</p>
          </div>
        </div>

        <div className="flex items-center justify-between">
          <div>
            <p className="text-[9px] text-slate-400 uppercase font-black mb-1">ID Ticket</p>
            <p className="text-xl font-black text-assirou-navy mono">{participant.numero_ticket.split('-').pop()}</p>
            <div className="mt-2 inline-flex items-center gap-2 px-3 py-1 bg-green-100 text-green-700 rounded-full text-[8px] font-black uppercase tracking-widest">
               <i className="fas fa-check-circle"></i> Confirmé
            </div>
          </div>
        ...
        <div className="mt-8 pt-6 border-t border-slate-200 text-center">
          <p className="text-[8px] font-black text-slate-300 uppercase tracking-[0.4em]">kaarange bi dall xel</p>
        </div>
      </div>
    </div>
  );
